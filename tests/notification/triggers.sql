...
SELECT notification_directory.create_notification_store('notification_triggers_data_source');
SELECT notification_directory.create_notification_store('another_data_source_name');

SELECT has_table('notification', 'notification_triggers_data_source',
...
SELECT bag_eq(
    ...
    ARRAY['notification_triggers_data_source', 'another_data_source_name'],
...
SELECT notification_directory.delete_notification_store(ns)
  ...
  WHERE ds.name = 'notification_triggers_data_source';
...
SELECT hasnt_table('notification', 'notification_triggers_data_source',
...
SELECT lives_ok(
    $$ DELETE FROM directory.data_source WHERE name = 'notification_triggers_data_source'; $$,
