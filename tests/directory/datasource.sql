...
SELECT isnt(directory.name_to_ds('datasource'), null, 'Data sources can be found by name');

SELECT isnt(directory.name_to_ds('othersource'), null, 'Data sources by name are created if necessary');
...
SELECT isnt(directory.delete_ds('datasource'), null, 'Data sources can be deleted');

SELECT is(directory.get_ds('datasource'), null, 'Deleted data sources are removed');

SELECT isnt(directory.get_ds('othersource'), null, 'Other data sources are not removed on removal');
