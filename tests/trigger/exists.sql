...
SELECT ok(trigger.table_exists('logging', 'job'), 'existing table is found');
SELECT ok(not trigger.table_exists('logging', 'utter_nonsense'), 'non-existing table is not found');
