...
COMMENT ON COLUMN "trend_directory"."view_materialization"."dst_trend_store_id" IS 'The ID of the destination table_trend_store';
...
CREATE UNIQUE INDEX "ix_view_materialization_uniqueness" ON "trend_directory"."view_materialization" USING btree (dst_trend_store_id);
...
CREATE FUNCTION "trend_directory"."dst_trend_store"(trend_directory.view_materialization)
    RETURNS trend_directory.table_trend_store
AS $$
