...
COMMENT ON COLUMN "trend_directory"."view_materialization_state"."max_modified" IS 'The greatest modified timestamp of all materialization sources';

COMMENT ON COLUMN "trend_directory"."view_materialization_state"."source_states" IS 'Array of trend_store_id/timestamp/modified combinations for all source data fragments';

COMMENT ON COLUMN "trend_directory"."view_materialization_state"."processed_states" IS 'Array containing a snapshot of the source_states at the time of
