...
if [ -z "${BASE_URL-}" ]; then
  BASE_URL="https://github.com/hendrikx-itc/minerva-admin/releases"
fi
...
URL="${BASE_URL}/latest/download/minerva-admin-${TARGET}.${EXT}"
info "Tarball URL: ${UNDERLINE}${BLUE}${URL}${NO_COLOR}"
confirm "Install Minerva admin ${GREEN}latest${NO_COLOR} to ${BOLD}${GREEN}${BIN_DIR}${NO_COLOR}?"
